...
public class OSGiTest {
	...
	public void testFelix() throws Exception {
		...
		bundleJar.addAsManifestResource(new StringAsset("Manifest-Version: 1.0"
				...
				+ "Bundle-Activator: " + MyBundleActivator.class.getName()
	...
	public void testDependency() throws Exception {
		...
		dependencyBundleJar.addAsManifestResource(new StringAsset(
				...
				"MANIFEST.MF");
		ZipExporter dependencyZipExporter = new ZipExporterImpl(
				dependencyBundleJar);
		dependencyZipExporter.exportTo(dependencyBundleFile, true);
		bundleContext.installBundle(dependencyBundleFile.toURI().toURL()
				.toString());
		LOG.debug("exporting package: "
				+ SomeClass.class.getPackage().getName());
		...
		bundleJar.addAsManifestResource(
				new StringAsset("Manifest-Version: 1.0" + '\n'
						...
						+ SomeClass.class.getPackage().getName() + '\n'
						+ "Bundle-Activator: "
						+ DependentBundleActivator.class.getName() + '\n'),
				"MANIFEST.MF");
		ZipExporter zipExporter = new ZipExporterImpl(bundleJar);
		zipExporter.exportTo(bundleFile, true);
	...
	public void testBundle() throws Exception {
		...
		wsBundleJar.addPackages(true,
				DigitalSignatureServiceFactory.class.getPackage());
		...
		JavaArchive dependencyBundleJar = ShrinkWrap.create(JavaArchive.class);
		dependencyBundleJar.addPackage(DigitalSignatureServiceClient.class
				.getPackage());
		dependencyBundleJar
				.addAsManifestResource(
						new StringAsset(
								"Manifest-Version: 1.0"
										...
										+ '\n'
										+ "Bundle-SymbolicName: "
										+ DigitalSignatureServiceClient.class
												.getPackage().getName()
										+ '\n'
										+ "Import-Package: "
										+ ConversationException.class
												.getPackage().getName()
										+ ","
										+ LogFactory.class.getPackage()
												.getName()
										+ ","
										+ DigitalSignatureServiceFactory.class
												.getPackage().getName()
										+ ","
		...
		bundleContext
				.installBundle(clientBundleFile.toURI().toURL().toString());
		LOG.debug("exporting package: "

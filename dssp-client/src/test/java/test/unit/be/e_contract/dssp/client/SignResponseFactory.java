...
public class SignResponseFactory {
	...
	public static String createSignResponse(String responseId, String destination, String inResponseTo, String tokenId,
			byte[] tokenKey) {
	...
	public static String createSignResponse(String responseId, String destination, String inResponseTo, String tokenId,
			byte[] tokenKey, String resultMajor, String resultMinor, String signerIdentity) {

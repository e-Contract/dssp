 ...
 *
 */
public class AuthorizedSubjectsSignatureAuthorization implements SignatureAuthorization {
	 ...
	 *            the signatory subject DNs that are authorized to sign. An
	 *            authorized subject can be an regular expression.
	 */
	public AuthorizedSubjectsSignatureAuthorization(Set<String> authorizedSubjects) {
	...
	public PolicyType getXACMLPolicy() {
		...
		for (String authorizedSubject : this.authorizedSubjects) {

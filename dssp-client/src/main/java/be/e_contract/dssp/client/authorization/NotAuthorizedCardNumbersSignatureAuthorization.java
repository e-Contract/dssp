...
/**
 * Signature authorization based on eID card numbers that are NOT allowed to
 * sign.
 *
 * @author Frank Cornelis
 *
 */
public class NotAuthorizedCardNumbersSignatureAuthorization implements SignatureAuthorization {

	private final Set<String> notAuthorizedCardNumbers;
	 ...
	 * Main constructor.
	 *
	 * @param notAuthorizedCardNumbers
	 *            the signatory eID card numbers that are not authorized to
	 *            sign.
	 */
	public NotAuthorizedCardNumbersSignatureAuthorization(Set<String> notAuthorizedCardNumbers) {
		this.notAuthorizedCardNumbers = notAuthorizedCardNumbers;
	...
	public PolicyType getXACMLPolicy() {
...

		{
			RuleType rule = this.xacmlObjectFactory.createRuleType();
			policy.getCombinerParametersOrRuleCombinerParametersOrVariableDefinition().add(rule);
			rule.setRuleId("deny-specific-card-number");
			...
			for (String notAuthorizedCardNumber : this.notAuthorizedCardNumbers) {
				...
				attributeValue.getContent().add(notAuthorizedCardNumber);
